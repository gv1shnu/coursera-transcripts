...
- **Lecture #:** 15
- **URL:** https://www.coursera.org/learn/intermediate-postgresql/lecture/LMaWo/demo-reading-and-parsing-files
- **Extracted:** 2026-06-22 20:26:41
...
So here we got some vertical replication, two things like make and model of whatever it is, we got some vertical replication. So we're going to end up with a little table that is our lookup table here. That is this second thing that says B is 1 and then we're going to end up with numbers like foreign key into this table y_id, and we're going to put these in, right? So I could give you as an assignment take this data, make two tables, send one as a foreign key into the other and put the second column in and just put the distinct values.

Sound familiar? Just put the distinct values of that second column into here. That's what I want you to do and I want you to do it by hand. So what we're going to do in this particular thing is we're going to automate it.
