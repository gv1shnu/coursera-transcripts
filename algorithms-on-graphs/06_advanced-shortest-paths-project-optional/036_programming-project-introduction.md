...
- **Lecture #:** 36
- **URL:** https://www.coursera.org/learn/algorithms-on-graphs/lecture/uFWUN/programming-project-introduction
- **Extracted:** 2026-06-21 21:28:56

---

Hi, in this module, you will be working on a project based on Advanced Shortest Paths algorithms. The project will be organized as a series of programming assignments similar to those you had in the previous modules. However, in these programming assignments, you will be working with real world data, based on raw networks and social networks. Also, you will have more freedom to come up with your own creative ideas about how to improve your algorithms.

You even can compete with your fellow learners on the forums on how fast does your algorithm solve a particular problem in the problem assignment. You've learned the classical shortest paths algorithms in two of the previous modules. And you've learned the Breadth First Search Algorithm, Dijkstra's Algorithm and Bellman Ford's Algorithm. The advanced algorithms can be faster thousands of times, or sometimes of million of times in practice.
